...
frappe.ui.form.on("Opportunity Hotels", {
    ...
    make_supplier_quotation: function (frm) {
		frappe.model.open_mapped_doc({
			method: "ion_crm_sales.ion_crm_sales.doctype.opportunity_hotels.opportunity_hotels.make_supplier_quotation",
			frm: frm,
		});
	},
	...
	make_request_for_quotation: function (frm) {
		frappe.model.open_mapped_doc({
			method: "ion_crm_sales.ion_crm_sales.doctype.opportunity_hotels.opportunity_hotels.make_request_for_quotation",
			frm: frm,
		});
	},
    ...
    create_quotation() {
		frappe.model.open_mapped_doc({
			method: "ion_crm_sales.ion_crm_sales.doctype.opportunity_hotels.opportunity_hotels.make_quotation",
			frm: cur_frm,
		});
	},
