...
def make_supplier_quotation(source_name, target_doc=None):
	...
	def set_missing_values(source, target):
		for fieldname in ("custom_sm_opportunity", "custom_opportunity_sm"):
	...
	doclist = get_mapped_doc(
		...
		source_name,
		{
			"Opportunity SM": {"doctype": "Supplier Quotation"},
			"Opportunity Item": {
...
def make_material_request(source_name, target_doc=None):
	def set_missing_values(source, target):
		...
		if frappe.get_meta("Material Request").has_field("custom_sm_opportunity"):
			material_request.custom_sm_opportunity = source.name
